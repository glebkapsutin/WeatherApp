...
2. Скачайте файл `WeatherAPP_1.1.1.0_x64_Debug.msix`.  
3. Дважды кликните по нему, чтобы установить приложение.  
4. **Если система запросит установить "Windows App Runtime" — подтвердите установку**. Это официальная библиотека от Microsoft, необходимая для запуска MAUI-приложений.  
